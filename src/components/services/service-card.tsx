...
export function ServiceCard({ service }: ServiceCardProps) {
  return (
    <article
      id={service.slug}
      className="flex h-full scroll-mt-24 flex-col rounded-[var(--radius-md)] border border-forest-border/15 bg-white p-5 shadow-sm"
    >
      ...
      <div className="mt-4 flex flex-col gap-3">
        ...
        <div className="flex justify-end border-t border-[var(--sand-200)] pt-3">
          <Link
